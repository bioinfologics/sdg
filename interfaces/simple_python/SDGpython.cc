...
PYBIND11_MODULE(SDGpython, m) {
    ...
    py::class_<HappySorter>(m, "HappySorter", "HappySorter")
            ...
            .def("recruit_all_happy_threads", &HappySorter::recruit_all_happy_threads,"min_happiness"_a=-1,"min_nodes"_a=-1,"end_sizes"_a=-1)
            ...
            .def("fast_grow_loop",&HappySorter::fast_grow_loop, "min_threads"_a=-1, "min_happiness"_a=-1, "steps"_a=INT64_MAX, "verbose"_a=false)
