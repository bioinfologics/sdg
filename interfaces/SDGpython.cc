...
PYBIND11_MODULE(SDGpython, m) {
    ...
    py::class_<DistanceGraph>(m, "DistanceGraph", "A Distance Graph")
            ...
            .def("dump",&DistanceGraph::dump, "filename"_a)
            .def("load",&DistanceGraph::load, "filename"_a)
    ...
    py::class_<ReadThreadsGraph,DistanceGraph>(m, "ReadThreadsGraph", "A Read Threads Graph")
            ...
            .def("reduced_graph",py::overload_cast<int , int >(&ReadThreadsGraph::reduced_graph),"min_thread_nodes"_a,"min_node_threads"_a)
            .def("reduced_graph",py::overload_cast<std::unordered_set<sgNodeID_t> >(&ReadThreadsGraph::reduced_graph),"nodes"_a)
...
//                 ;
    ...
    py::class_<WorkSpace>(m, "WorkSpace", "A full SDG WorkSpace")
            ...
            .def("add_long_reads_datastore",&WorkSpace::add_long_reads_datastore,"datastore"_a,"name"_a="",py::return_value_policy::reference_internal)
            .def("add_paired_reads_datastore",&WorkSpace::add_paired_reads_datastore,"datastore"_a,"name"_a="",py::return_value_policy::reference_internal)
            .def("add_linked_reads_datastore",&WorkSpace::add_linked_reads_datastore,"datastore"_a,"name"_a="",py::return_value_policy::reference_internal)
            .def("add_kmer_counter",py::overload_cast<const std::string &, uint8_t , KmerCountMode >(&WorkSpace::add_kmer_counter),"name"_a,"k"_a=31,"count_mode"_a=KmerCountMode::Canonical,py::return_value_policy::reference_internal)
            .def("add_kmer_counter",py::overload_cast<const std::string &, const std::string &>(&WorkSpace::add_kmer_counter),"filename"_a,"name"_a="",py::return_value_policy::reference_internal)
            .def("get_long_reads_datastore",&WorkSpace::get_long_reads_datastore,"name"_a,py::return_value_policy::reference_internal)
            .def("get_paired_reads_datastore",&WorkSpace::get_paired_reads_datastore,"name"_a,py::return_value_policy::reference_internal)
            .def("get_linked_reads_datastore",&WorkSpace::get_linked_reads_datastore,"name"_a,py::return_value_policy::reference_internal)
            .def("get_kmer_counter",&WorkSpace::get_kmer_counter,"name"_a,py::return_value_policy::reference_internal)
    ...
    py::class_<LongReadsRecruiter>(m, "LongReadsRecruiter", "Long reads exact mapper, threader, etd")
            ...
            .def("find_all_valid_blocks",&LongReadsRecruiter::find_all_valid_blocks,"matches"_a,"min_count"_a,"min_bp"_a=1)
            .def("simple_thread_reads",&LongReadsRecruiter::simple_thread_reads,"min_count"_a=1,"min_bp"_a=1)
    ...
    py::class_<GraphContigger>(m,"GraphContigger","Paired end contigger")
            ...
            .def("remove_low_kcov_nodes",&GraphContigger::remove_low_kcov_nodes,"counter_name"_a, "count_name"_a, "low_cov"_a, "max_size"_a)
            .def("pop_bubbles",&GraphContigger::pop_bubbles,"datastore"_a,"bubble_size"_a=200,"min_support"_a=4,"max_noise"_a=3,"snr"_a=10)
            .def("solve_canonical_repeats",&GraphContigger::solve_canonical_repeats,"datastore"_a,"min_support"_a=5,"max_noise"_a=2,"snr"_a=10)
...
//            ;
    ...
    py::class_<RTGPartition>(m, "RTGPartition", "RTGPartition")
            ...
            .def("classify_all_threads",&RTGPartition::classify_all_threads,"min_nodes"_a=50,"max_classified_node_perc"_a=0.05,"max_threads"_a=-1)
