...
public:
    ...
    const SequenceDistanceGraph& getGraph() const { return mapper.getGraph(); }
...
public:
    explicit MappingThread(const SequenceDistanceGraph& _sg) : ordered_mappings(), node_path(_sg) {};
