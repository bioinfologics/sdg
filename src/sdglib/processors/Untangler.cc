...
std::vector<std::vector<std::pair<sgNodeID_t,uint32_t>>> Untangler::find_tag_neighbours(uint32_t min_size, float min_ci, float max_ci) {
    ...
    sdglib::OutputLog()<<tag_10<<" selected_nodes have 10+ tags"<<std::endl;
    sdglib::OutputLog()<<tag_50<<" selected_nodes have 50+ tags"<<std::endl;
    sdglib::OutputLog()<<tag_100<<" selected_nodes have 100+ tags"<<std::endl;
    sdglib::OutputLog()<<tag_1000<<" selected_nodes have 1000+ tags"<<std::endl;

    sdglib::OutputLog()<<"Computing shared tags"<<std::endl;
...
#pragma omp critical
    ...
    sdglib::OutputLog()<<with_neighbours<<" selected_nodes with neighbours"<<std::endl;
    return neighbours;
}
