...
public:
    ...
    void create_patch(std::vector<sgNodeID_t> reconneciton_group);//takes all reads from the reconnection group, creates a local assembly, gets the lines from it.
